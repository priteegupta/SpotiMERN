...
const AdminRegisterPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Pass role: "admin" explicitly in request payload
      ...
      setSuccessMsg(result.message || "Admin registered successfully! Redirecting to login...");
    ...
    >
      ...
      >
        ...
        <div className="text-center mt-3 border-top border-secondary pt-3">
          ...
          <Link to="/admin/login" className="text-success fw-bold text-decoration-none hover-white" style={{ fontSize: "0.85rem" }}>
            Admin Login
          </Link>
          <br />
          <Link to="/" className="text-muted text-decoration-none hover-white d-inline-block mt-2" style={{ fontSize: "0.8rem" }}>
            ← Back to Home
          </Link>
        </div>
      </div>
